...
exam <- function(){
    ...
    # Figure 2(a) in the manuscript: n = 100, q = 0.2, scenario 1
    ...
    filename = paste("n=100","rho=0.5","tau=0.2","s1", "bar",".png", sep="_")
    ggsave(filename, plot1, width=28, height=28, units='cm')
    
    filename = paste("n=100","rho=0.5","tau=0.2","s1", "bar",".eps", sep="_")
    ggsave(filename, plot1, width=28, height=28, units='cm')

    # Figure 2(b) in the manuscript: n = 200, q = 0.2, scenario 1
    ...
    filename = paste("n=200","rho=0.5","tau=0.2","s1", "bar",".png", sep="_")
    ggsave(filename, plot1, width=28, height=28, units='cm')
    
    filename = paste("n=200","rho=0.5","tau=0.2","s1", "bar",".eps", sep="_")
    ggsave(filename, plot1, width=28, height=28, units='cm')

    # Figure 3(a) in the manuscript: n = 100, q = 0.5, scenario 1
    ...
    filename = paste("n=100","rho=0.5","tau=0.5","s1", "bar",".png", sep="_")
    ggsave(filename, plot1, width=28, height=28, units='cm')
    
    filename = paste("n=100","rho=0.5","tau=0.5","s1", "bar",".eps", sep="_")
    ggsave(filename, plot1, width=28, height=28, units='cm')

    # Figure 3(b) in the manuscript: n = 200, q = 0.5, scenario 1
    ...
    filename = paste("n=200","rho=0.5","tau=0.5","s1", "bar",".png", sep="_")
    ggsave(filename, plot1, width=28, height=28, units='cm')
    
    filename = paste("n=200","rho=0.5","tau=0.5","s1", "bar",".eps", sep="_")
    ggsave(filename, plot1, width=28, height=28, units='cm')
}
